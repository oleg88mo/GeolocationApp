...
const Map = ({classes}) => {
    ...
    const handlerMapClick = ({lngLat, leftButton}) => {
    ...
    const hendlerDeletePin = async pin => {
        ...
        >
            ...
            {userPosition && (
                <Marker
                    ...
                    offsetTop={-38}
                >
                    <PinIcon size={40} color="rgb(40, 119, 27)"/>
                </Marker>
            )}
            ...
            {state.draft && (
                <Marker
                    ...
                    offsetTop={-38}
                >
                    <PinIcon size={40} color="rgb(0, 120, 212)"/>
                </Marker>
            )}
            ...
            {state.pins.map(pin => (
                <Marker
                    ...
                    offsetTop={-38}
                >
                    <PinIcon onClick={() => handlerSelectPin(pin)} size={40} color={highlightNewPin(pin)}/>
                </Marker>
            ))}
            ...
            {popup && (
                ...
                >
                    ...
                    <div className={classes.popupTab}>
                        ...
                        {isAuthUser() && (
                            <Button onClick={() => hendlerDeletePin(popup)}>
